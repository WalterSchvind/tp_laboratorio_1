...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    if(this!=NULL&&nodeIndex>=0&&nodeIndex<ll_len(this))
    {
        ...
        {
            retorno=retorno->pNextNode;
        }//ESTO CON UN FOR CUALQUIERA DE LOS DOS FUNCAN
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        ...
        if(actual!=NULL)
        {
            ...
            {
                //remuevo el nodo entre dos nodos

                Node* previousNode = getNode(this,index - 1);

                previousNode->pNextNode = actual->pNextNode;
                free(actual);
                this->size = ll_len(this) - 1;
                returnAux = 0;
            }
...
int ll_indexOf(LinkedList* this, void* pElement)
{
    ...
    if (this!=NULL)
    {
        for(int i=0; i<ll_len(this); i++)
        {
            ...
            if (nodeAux->pElement==pElement)//si alguno de los nodos de la lista es igual al elemento que busco devuelvo el indice
            {
                returnAux = i;
            }
        }
...
{
    int returnAux = -1;//la lista es null

    if(this != NULL)
    {
        if( ll_len(this))//si la lista tiene el tamaño no esta vacia
        {
            returnAux = 0;
        }
        else//si no tiene tamaño esta vacia
        {
            returnAux = 1;
        }
    }
